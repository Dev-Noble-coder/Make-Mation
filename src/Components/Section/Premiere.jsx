      ...
      <div className='py-16 mx-5 sm:mx-10'>
        ...
        <div className='mt-10 sm:mt-16 grid grid-cols-1 lg:grid-cols-2 gap-6'>
          ...
          <motion.div
            ...
            variants={fadeInUp}
          >
            <h3 className='text-xl font-semibold pb-2'>Meet The Actors.</h3>
            ...
            <p className='text-md font-semibold py-3'>Don't Miss It !!!</p>
            <Link to=''>
              <button className='bg-yellow-400 py-2 px-5 text-white text-md font-semibold'>Join the Waitlist</button>
            </Link>
          </motion.div>
