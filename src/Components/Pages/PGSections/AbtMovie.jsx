...
const AbtMovie = () => {
    return (
        <div className=' mx-5 sm:mx-10 my-20 font-montserrat'>
            <h1 className='text-3xl font-semibold pb-2'>GENRE: Drama, Coming-of-Age</h1>
            <h2 className='text-2xl font-semibold pb-5'>SUB-GENRE: Inspirational, Comedy, Subtle Romance</h2>

            <h3 className='text-2xl font-semibold'>SCREENPLAY written by:</h3>
            <p className='text-xl pb-5'>Nengi Diri, Toyosi Akerele-Ogunsiji</p>

            <h3 className='text-2xl font-semibold pb-5'>LOGLINE:</h3>
            
            <p className='text-xl pb-3 leading-8'>
            ...
            <h3 className='text-2xl font-semibold  pb-5'>Summary:</h3>
            <p className='text-xl  pb-3 leading-8'>
