      ...
      <div className='py-16 mx-5 sm:mx-10 '>
            ...
            <div className=' grid grid-cols-1 lg:grid-cols-2 place-items-center mt-10 sm:mt-16'>
                <div>
                    ...
                    <p className='text-xl leading-8 sm:leading-10'>She is the director of the movie called <span className='text-2xl font-bold'>MAKE <span className='text-yellow-400'>MATION</span></span></p>
                </div>
                <div>
